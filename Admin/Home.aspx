                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link" href="manage_customer.aspx">Manage Customer</a>
                                </li>
                               
                                <%-- <li class="nav-item">
                                    <a class="nav-link" href="manage_notification.aspx">Notification</a>
                                </li>--%>
                              
                                 <li class="nav-item">
                                    <a class="nav-link" href="manage_shop.aspx">Shop</a>
                                </li>
                                <%-- <li class="nav-item">
                                    <a class="nav-link" href="view_user.aspx">User</a>
                                </li>--%>
                              
                                  <li class="nav-item">
                                    <a class="nav-link" href="viewsales.aspx">View Sales</a>
                                </li>
                                  <li class="nav-item">
                                    <a class="nav-link" href="admin_login.aspx">Logout</a>
                                </li>
